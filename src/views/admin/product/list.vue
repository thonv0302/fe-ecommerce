          ...
          <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
              <tr>
                <th
                  scope="col"
                  class="p-3 text-left text-sm font-medium text-gray-500 tracking-wider flex items-center"
                >
                  <input
                    ref="checkbox"
                    type="checkbox"
                ...
                <th
                  scope="col"
                  class="p-3 text-left text-sm font-medium text-gray-500 tracking-wider"
                >
                  Status
                </th>
                <th
