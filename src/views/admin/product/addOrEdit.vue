      ...
      <div class="grid grid-cols-1 md:grid-cols-3 md:gap-x-4">
        <div class="col-span-2">
          <div class="bg-white shadow-sm border rounded-md p-3">
            ...
            <div class="mt-3">
              <label for="password" class="block text-sm text-gray-70">
                Description
              </label>
              <div
...
const test = ref('<p>chao cau</p>');

const images = ref([
  {
    id: 1,
    url: 'https://w0.peakpx.com/wallpaper/106/965/HD-wallpaper-rose-blackpink-blackpink-rose-kpop-on-the-ground-park-chaeyoung-rose-on-the-ground-roseanne.jpg',
  },
  {
    id: 2,
    url: 'https://w0.peakpx.com/wallpaper/462/819/HD-wallpaper-rose-blackpink-kpop.jpg',
  },
  {
    id: 3,
    url: 'https://w0.peakpx.com/wallpaper/748/772/HD-wallpaper-rose-blackpink-korean.jpg',
  },
  {
    id: 4,
    url: 'https://w0.peakpx.com/wallpaper/112/630/HD-wallpaper-rose-blackpink-rose.jpg',
  },
  {
    id: 5,
    url: 'https://w0.peakpx.com/wallpaper/112/630/HD-wallpaper-rose-blackpink-rose.jpg',
