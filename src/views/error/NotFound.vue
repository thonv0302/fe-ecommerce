...
import { ROUTE_HOME } from '@/constants/routers';
</script>
<template>
  <div
    class="h-[100vh] bg-cover bg-top sm:bg-top"
    style="
  ...
  >
    <div
      class="max-w-7xl h-full mx-auto px-4 py-16 text-center sm:px-6 sm:py-24 lg:px-8 lg:py-48"
    >
      <p
