...
<template>
  <h2 class="text-2xl font-extrabold text-gray-900 flex items-center">
    ...
    </RouterLink>Sign in to your account
  </h2>
  ...
  <div class="mt-8">
    <VeeForm class="space-y-6" v-slot="{ errors }" @submit="onLogin">
      <div>
        ...
        <div class="mt-1">
          <VeeField id="email" name="email" type="email" autocomplete="email" v-model="loginInfo.email" rules="required"
            :class="[
      ...
      <div class="space-y-1">
        ...
        <div class="mt-1">
          <VeeField id="password" name="password" type="password" v-model="loginInfo.password" rules="required" :class="[
            'block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none sm:text-sm',
            {
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          <VeeField id="remember-me" name="remember-me" type="checkbox" v-model="rememberMe" :value="true"
    ...
    <div class="text-center mt-2">
      <RouterLink :to="{ name: ROUTE_AUTH.register.name }"
